...
@endsection
@section('cssNeeded')
    <link rel="stylesheet" href="{{asset('pages/css/supplier/index.css')}}">
@endsection
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body px-5 pt-0 pb-4">
                    <table class="table align-items-center align-middle" id="tb_Supplier" style="width:100%">
                    </table>
                </div>
            </div>
        </div>
        @include('pages.supplier.include.modalSupplier')
    </div>
@endsection
@section('jsRequired')
...
@endsection
@section('jsNeeded')
    <script src="{{ asset('pages/js/supplier/index.js') }}"></script>
@endsection
