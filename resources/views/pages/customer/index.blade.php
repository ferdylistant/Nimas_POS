...
@endsection
@section('cssNeeded')
    <link rel="stylesheet" href="{{asset('pages/css/customer/index.css')}}">
@endsection
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-5 my-auto text-end">
                            <a class="btn btn-sm btn-primary" href="?modal=add" data-bs-toggle="modal"
                                            data-bs-target="#mdCustomer"><i
                ...
                <div class="card-body px-5 pt-0 pb-4">
                    <table class="table align-items-center align-middle" id="tb_Customer" style="width:100%">
                    </table>
                </div>
            </div>
        </div>
        @include('pages.customer.include.modalCustomer')
    </div>
@endsection
@section('jsRequired')
...
@endsection
@section('jsNeeded')
    <script src="{{ asset('pages/js/customer/index.js') }}"></script>
@endsection
