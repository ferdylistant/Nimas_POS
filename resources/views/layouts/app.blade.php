...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vendors/loadingModal/css/jquery.loadingModal.css') }}">
...
<body class="g-sidenav-show  bg-gray-100">
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <i class="fa fa-user-cog me-sm-4"></i>
                                            </div>
                                            <div class="my-auto">
                                                <h6 class="text-sm font-weight-normal mb-1">User Profile</h6>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md bg-red logout-confirm" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <i class="fa fa-sign-out-alt me-sm-4"></i>
                                            </div>
                                            <div class="my-auto">
    ...
    <script>
        ...
        // if (win && document.querySelector('.scrollbar-class')) {
        //     var options = {
        //         damping: '0.5'
        //     }
        //     Scrollbar.init(document.querySelector('.scrollbar-class'), options);
        // }
        var win = navigator.platform.indexOf('Win') > -1;
