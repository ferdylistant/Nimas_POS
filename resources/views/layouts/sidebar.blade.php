<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white"
    ...
    <div class="sidenav-header text-center">
        ...
        <a class="navbar-brand m-0" href="{{ url('/') }}">
            <img src="{{ asset('assets/img/logo.png') }}" class="navbar-brand-img h-100" style="width: 90px;" alt="main_logo">
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto scrollbar-class" style="height: 70%" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::segment(1) == 'transaction' ? 'active' : '' }}" data-bs-toggle="collapse" href="#transactionNav" role="button"
                    aria-expanded="false" aria-controls="transactionNav">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <div class="collapse {{ Request::segment(1) == 'transaction' ? 'show' : '' }}" id="transactionNav">
                    <div class="pt-1 ps-3">
                        <a class="nav-link {{ Request::segment(2) == 'orders' ? 'active' : '' }}"
                            ...
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex justify-content-center">
                                <i
                                    class="fas fa-circle {{ Request::segment(2) == 'orders' ? '' : 'text-dark' }}"></i>
                            </div>
