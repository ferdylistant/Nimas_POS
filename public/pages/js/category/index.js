$(document).ready(function () {
    ...
    let tbCategory = $('#tb_Category').DataTable({
        ...
        columns: [
            ...
            { data: 'category_name', name: 'category_name', title: 'Kategori Produk', className: 'text-center' },
            { data: 'created_at', name: 'created_at', title: 'Tanggal Dibuat', className: 'text-center' },
            { data: 'updated_at', name: 'updated_at', title: 'Tanggal Diubah', className: 'text-center' },
